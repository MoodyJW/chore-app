...
const DEFAULT_CHORES = [
  ...
  { name: "Clean out fridge", recurrence: "sunday", display_order: 0 },
  { name: "Tidy office", recurrence: "sunday", display_order: 1 },
  { name: "Wipe down desk and computer keyboard", recurrence: "sunday", display_order: 2 },
  { name: "Organize pantry", recurrence: "sunday", display_order: 3 },
  // Monday — Bathrooms
  { name: "Scrub toilet(s)", recurrence: "monday", display_order: 0 },
  { name: "Clean sink(s)", recurrence: "monday", display_order: 1 },
  { name: "Mop bathroom floor(s)", recurrence: "monday", display_order: 2 },
  { name: "Wipe mirrors", recurrence: "monday", display_order: 3 },
  { name: "Replace towels", recurrence: "monday", display_order: 4 },
  // Tuesday — Bedrooms
  { name: "Vacuum bedroom(s)", recurrence: "tuesday", display_order: 0 },
  { name: "Dust surfaces", recurrence: "tuesday", display_order: 1 },
  { name: "Change bed sheets", recurrence: "tuesday", display_order: 2 },
  { name: "Tidy closets", recurrence: "tuesday", display_order: 3 },
  // Wednesday — Kitchen
  { name: "Deep clean stove & oven", recurrence: "wednesday", display_order: 0 },
  { name: "Deep clean toaster oven", recurrence: "wednesday", display_order: 1 },
  { name: "Clean microwave", recurrence: "wednesday", display_order: 2 },
  { name: "Wipe cabinet fronts", recurrence: "wednesday", display_order: 3 },
  { name: "Mop kitchen floor", recurrence: "wednesday", display_order: 4 },
  { name: "Clean kitchen sink", recurrence: "wednesday", display_order: 5 },
  ...
  { name: "Vacuum / sweep living room", recurrence: "thursday", display_order: 0 },
