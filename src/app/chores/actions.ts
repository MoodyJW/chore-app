...
const DEFAULT_CHORES = [
  ...
  { name: "Sweep floor", recurrence: "thursday", display_order: 3 },
  { name: "Mop floor", recurrence: "thursday", display_order: 4 },
  { name: "Take boxes to dump if needed", recurrence: "thursday", display_order: 5 },
  // Friday — Laundry
  { name: "Dust ceiling", recurrence: "friday", display_order: 0 },
  { name: "Wipe down washer & dryer", recurrence: "friday", display_order: 1 },
  { name: "Wipe down cabinets and counter", recurrence: "friday", display_order: 2 },
  { name: "Sweep floor", recurrence: "friday", display_order: 3 },
  { name: "Mop floor", recurrence: "friday", display_order: 4 },
  { name: "Tidy space as needed", recurrence: "friday", display_order: 5 },
  // Saturday — Outdoors
